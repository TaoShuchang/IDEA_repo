...
'''
CUDA_VISIBLE_DEVICES=4 nohup python -u run_idea.py --dataset ogbarxiv --weight_decay 0 --num_layers 3 --hidden_channels 256 --suffix oset_hid256_lay3_wd0_drop0.5 --num_sample 2 --atk_suffix seed123 > log/ogbarxiv_oset/oset_hid256_lay3_wd0_drop0.5.log 2>&1 &
...
'''
CUDA_VISIBLE_DEVICES=1 nohup python -u run_idea.py --dataset citeseer --suffix 5_idea_iter_lambda50_attr-4 --lambda_inv_risks 50 --perturb_size 1e-4 --atk_suffix seed123 > log/citeseer/5_idea_iter_lambda50_attr-4.log 2>&1 & 
...
'''
CUDA_VISIBLE_DEVICES=2 nohup python -u run_idea.py --dataset ogbarxiv --suffix idea_iter_selfloop_sam4_lambdair5  --num_sample 4 --lambda_inv_risks 5 --atk_suffix seed123 > log/ogbarxiv/idea_iter_selfloop_sam4_lambdair5.log 2>&1 & 




CUDA_VISIBLE_DEVICES=2 nohup python -u run_idea.py --dataset 12k_reddit --suffix idea_iter_sam4 --num_sample 4 --atk_suffix seed123 > log/12k_reddit/idea_iter_sam4.log 2>&1 & 
CUDA_VISIBLE_DEVICES=0 nohup python -u run_idea.py --dataset 12k_reddit --suffix idea_iter_selfloop_sam4 --num_sample 4 --atk_suffix seed123 > log/12k_reddit/idea_iter_selfloop_sam4.log 2>&1 & 
CUDA_VISIBLE_DEVICES=4 nohup python -u run_idea.py --dataset 12k_reddit --suffix idea_iter_selfloop_sam4_0.25 --num_sample 4 --atk_suffix seed123 > log/12k_reddit/idea_iter_selfloop_sam4_0.25.log 2>&1 & 
CUDA_VISIBLE_DEVICES=3 nohup python -u run_idea.py --dataset 10k_ogbproducts  --suffix idea_iter_selfloop_sam4_0.25 --num_sample 4 --atk_suffix seed123 > log/10k_ogbproducts/idea_iter_selfloop_sam4_0.25.log 2>&1 & 
CUDA_VISIBLE_DEVICES=1 nohup python -u run_idea.py --dataset 10k_ogbproducts  --suffix idea_iter_selfloop_sam4_0.15 --num_sample 4 --atk_suffix seed123 > log/10k_ogbproducts/idea_iter_selfloop_sam4_0.15.log 2>&1 & 



CUDA_VISIBLE_DEVICES=1 nohup python -u run_idea.py --dataset citeseer --suffix 5_idea_iter_lambda50_attr-4 --lambda_inv_risks 50 --perturb_size 1e-4 --atk_suffix seed123 > log/citeseer/5_idea_iter_lambda50_attr-4.log 2>&1 & 
CUDA_VISIBLE_DEVICES=0 nohup python -u run_idea.py --dataset cora --suffix 5_idea_iter_samp2_lambda100_attr-4 --lambda_inv_risks 100 --perturb_size 1e-4 --num_sample 2 --atk_suffix seed123 > log/cora/5_idea_iter_samp2_lambda100_attr-4.log 2>&1 &

CUDA_VISIBLE_DEVICES=2 nohup python -u run_idea.py --dataset 10k_ogbproducts  --suffix 5_idea_iter_selfloop_sam4 --num_sample 4 --atk_suffix seed123 > log/10k_ogbproducts/5_idea_iter_selfloop_sam4_0.1.log 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup python -u run_idea.py --dataset 10k_ogbproducts  --suffix 5_idea_iter_selfloop_sam4 --num_sample 4 --atk_suffix seed123 > log/10k_ogbproducts/5_idea_iter_selfloop_sam4_0.2.log 2>&1 &
CUDA_VISIBLE_DEVICES=4 nohup python -u run_idea.py --dataset 10k_ogbproducts  --suffix 5_idea_iter_selfloop_sam4 --num_sample 4 --atk_suffix seed123 > log/10k_ogbproducts/5_idea_iter_selfloop_sam4_0.3.log 2>&1 &


CUDA_VISIBLE_DEVICES=2 nohup python -u run_idea.py --dataset 12k_reddit --lambda_inv_risks 100 --suffix idea_iter_samp2_lambda100_attr-4 --num_sample 2 --perturb_size 1e-4 --atk_suffix seed123 > log/12k_reddit/idea_iter_samp2_lambda100_attr-4_0.25.log 2>&1 &


CUDA_VISIBLE_DEVICES=3 nohup python -u run_idea.py --dataset cora --suffix idea_iter_selfloop --atk_suffix seed123 > log/cora/idea_iter_selfloop.log 2>&1 & 
CUDA_VISIBLE_DEVICES=2 nohup python -u run_idea.py --dataset pubmed --suffix idea_iter --atk_suffix pre > log/pubmed/idea_iter.log 2>&1 & 

CUDA_VISIBLE_DEVICES=0 nohup python -u run_idea.py --dataset citeseer --num_sample 4 --suffix idea_iter_samp4_lambda50_selfloop --lambda_inv_risks 50 --atk_suffix seed123 > log/citeseer/idea_iter_samp4_lambda50_selfloop.log 2>&1 & 
CUDA_VISIBLE_DEVICES=1 nohup python -u run_idea.py --dataset cora --suffix idea_iter_lambda200_selfloop --lambda_inv_risks 200 --atk_suffix seed123 > log/cora/idea_iter_lambda50_selfloop.log 2>&1 & 
CUDA_VISIBLE_DEVICES=0 nohup python -u run_idea.py --dataset cora --lambda_inv_risks 100 --suffix idea_iter_samp2_lambda100_attr-4 --num_sample 2 --perturb_size 1e-4 --atk_suffix seed123 > log/cora/idea_iter_samp2_lambda100_attr-4.log 2>&1 & 


CUDA_VISIBLE_DEVICES=0 nohup python -u run_idea.py --dataset citeseer --lambda_inv_risks 100 --suffix idea_iter_samp2_lambda100_attr-4 --num_sample 2 --perturb_size 1e-4 --atk_suffix seed123 > log/citeseer/idea_iter_samp2_lambda100_attr-4.log 2>&1 & 
CUDA_VISIBLE_DEVICES=4 nohup python -u run_idea.py --dataset 12k_reddit --lambda_inv_risks 100 --suffix idea_iter_samp2_lambda100_attr-4 --num_sample 2 --perturb_size 1e-4 --atk_suffix seed123 > log/12k_reddit/idea_iter_samp2_lambda100_attr-4_0.2.log 2>&1 & 
CUDA_VISIBLE_DEVICES=2 nohup python -u run_idea.py --dataset 12k_reddit --lambda_inv_risks 100 --suffix idea_iter_samp2_lambda100 --num_sample 2 --atk_suffix seed123 > log/12k_reddit/idea_iter_samp2_lambda100_0.0.log 2>&1 & 

'''

"""Ablation Study
CUDA_VISIBLE_DEVICES=0 nohup python -u run_idea.py --dataset cora --suffix erm_idea_iter_samp2_lambda100_attr-4 --lambda_inv_risks 100 --perturb_size 1e-4 --num_sample 2 --atk_suffix seed123 > log/cora/erm_idea_iter_samp2_lambda100_attr-4.log 2>&1 &
CUDA_VISIBLE_DEVICES=1 nohup python -u run_idea.py --dataset cora --suffix wo_irm_idea_iter_samp2_lambda100_attr-4 --lambda_inv_risks 100 --perturb_size 1e-4 --num_sample 2 --atk_suffix seed123 > log/cora/wo_irm_idea_iter_samp2_lambda100_attr-4.log 2>&1 &
CUDA_VISIBLE_DEVICES=2 nohup python -u run_idea.py --dataset cora --suffix wo_nei_irm_idea_iter_samp2_lambda100_attr-4 --lambda_inv_risks 100 --perturb_size 1e-4 --num_sample 2 --atk_suffix seed123 > log/cora/wo_nei_irm_idea_iter_samp2_lambda100_attr-4.log 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup python -u run_idea.py --dataset cora --suffix wo_attr_idea_iter_samp2_lambda100_attr-4 --lambda_inv_risks 100 --perturb_size 1e-4 --num_sample 2 --atk_suffix seed123 > log/cora/wo_attr_idea_iter_samp2_lambda100_attr-4.log 2>&1 &
CUDA_VISIBLE_DEVICES=4 nohup python -u run_idea.py --dataset cora --suffix wo_struc_idea_iter_samp2_lambda100_attr-4 --lambda_inv_risks 100 --perturb_size 1e-4 --num_sample 2 --atk_suffix seed123 > log/cora/wo_struc_idea_iter_samp2_lambda100_attr-4.log 2>&1 &
"""