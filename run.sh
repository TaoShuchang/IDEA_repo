...
# Citeseer
nohup python -u main.py --dataset citeseer  --alpha 100 --dom_num 10 --num_sample 8 > log/citeseer.log 2>&1 &

# Reddit
nohup python -u main.py --dataset reddit --alpha 10 --dom_num 10 --perturb_size 1e-3 --device 2 > log/reddit.log 2>&1 &

# ogbn-products
nohup python -u main.py --dataset ogbproducts --alpha 10 --dom_num 10 --perturb_size 1e-3 --device 3 > log/ogbproducts.log 2>&1 &
