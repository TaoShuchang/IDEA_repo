...
def main(opts):
    ...
    for pert in np.arange(0, 0.3, 0.05):
        ...
        # seeds = [121, 122, 123, 124, 125, 126, 127, 128, 129]
        seeds = [120]
        ...
        for i in seeds:
            setup_seed(i)
            print('----------- Seed ',i, '-----------')
            model = RGCN(nnodes=features.shape[0], nfeat=features.shape[1], nclass=labels.max()+1,
...
'''
nohup python -u run_rgcn.py --dataset ogbarxiv --suffix testtime_rgcn --atk_suffix seed123 --gpu 1 > log/ogbarxiv/testtime_rgcn.log 2>&1 & 



nohup python -u run_rgcn.py --dataset ogbarxiv --suffix rgcn --atk_suffix seed123 --gpu 0 > log/ogbarxiv/rgcn_120.log 2>&1 & 
nohup python -u run_rgcn.py --dataset 12k_reddit --suffix rgcn --atk_suffix seed123 --gpu 0 > log/12k_reddit/rgcn.log 2>&1 & 
nohup python -u run_rgcn.py --dataset 10k_ogbproducts --suffix rgcn --atk_suffix seed123 --gpu 1 > log/10k_ogbproducts/rgcn.log 2>&1 & 

nohup python -u run_rgcn.py --dataset citeseer --suffix try --atk_suffix seed123 --gpu 3 > log/citeseer/try.log 2>&1 & 
nohup python -u run_rgcn.py --dataset cora --suffix rgcn --atk_suffix seed123 --gpu 4 > log/cora/rgcn.log 2>&1 & 
nohup python -u run_rgcn.py --dataset pubmed --suffix rgcn --atk_suffix pre --gpu 2 > log/pubmed/rgcn.log 2>&1 & 
