...
def main(args):
    ...
    split = np.aload('../../output/' + args.dataset+ '_split.npy').item()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='10k_ogbproducts')
...
'''
CUDA_VISIBLE_DEVICES=3 nohup python -u run_flag.py  --dataset 10k_ogbproducts --suffix vanilla > log/10k_ogbproducts/vanilla.log 2>&1 &
CUDA_VISIBLE_DEVICES=5 nohup python -u run_flag.py  --dataset 12k_reddit  --suffix vanilla > log/12k_reddit/vanilla.log 2>&1 &
CUDA_VISIBLE_DEVICES=6 nohup python -u run_flag.py  --dataset ogbarxiv --suffix vanilla > log/ogbarxiv/vanilla.log 2>&1 &

CUDA_VISIBLE_DEVICES=2 nohup python -u run_flag.py --dropout 0 --perturb_size 0.01 --lr 0.001 --use_ln 0 --layer_norm_first --dataset 12k_reddit --epochs 5000 --suffix fir_pert0.01_lr-3_drop0_acc_2 > log/12k_reddit/fir_pert0.01_lr-3_drop0_acc_2.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 nohup python -u run_flag.py --dropout 0.3 --perturb_size 0.1 --lr 0.01 --use_ln 1 --layer_norm_first --dataset 12k_reddit --epochs 5000 --suffix firln_pert0.1_lr-2 > log/12k_reddit/firln_pert0.1_lr-2.log 2>&1 &
CUDA_VISIBLE_DEVICES=0 nohup python -u run_flag.py --dropout 0.3 --perturb_size 0.01 --lr 0.001 --use_ln 1 --layer_norm_first --dataset 12k_reddit --epochs 5000 --suffix firln_pert0.01_lr-3_drop0.3_1 > log/12k_reddit/firln_pert0.01_lr-3_drop0.3_4.log 2>&1 &
CUDA_VISIBLE_DEVICES=5 nohup python -u run_flag.py --dropout 0.4 --perturb_size 0.01 --lr 0.001 --use_ln 1 --layer_norm_first --dataset 12k_reddit --epochs 5000 --suffix firln_pert0.01_lr-3_drop0.4 > log/12k_reddit/firln_pert0.01_lr-3_drop0.4.log 2>&1 &

CUDA_VISIBLE_DEVICES=2 nohup python -u run_flag.py --dropout 0.5 --perturb_size 0.2 --lr 0.001 --use_ln 1 --layer_norm_first --dataset 12k_reddit --epochs 5000 --suffix firln_pert0.2_lr-3_acc > log/12k_reddit/firln_pert0.2_lr-3_acc.log 2>&1 &
CUDA_VISIBLE_DEVICES=4 nohup python -u run_flag.py --dropout 0.5 --perturb_size 0.01 -m 10 --lr 0.001 --use_ln 1 --layer_norm_first --dataset 12k_reddit --epochs 5000 --suffix firln_pert0.01_m10_lr-3_acc > log/12k_reddit/firln_pert0.01_m10_lr-3_acc.log 2>&1 &
